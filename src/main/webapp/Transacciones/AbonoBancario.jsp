<%-- 
    Document   : AbonoBancario
    Created on : 12/11/2020, 10:44:47
    Author     : carlo
--%>
...
<html>
    <head>
        ...
        <title>Transaccion Bancaria</title>
    ...
    <body>
        <div class="main" >
            ...
            <c:if test="${success==0}">
                ...
                <br>
                <div class="container">
                    <form class="form" action="AbonoCuenta" onsubmit=" return validarAbonoForm();" method="POST">
                        ...
                        <div class="form-group row">
                            <label for="montoDepositar" class="col-md-2 col-form-label">Monto a depocitar: </label>
                            <div class="col-md-3">
                                <input type="text" class="form-control" id="montoDepositar" required="" name="montoDepositar">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-3">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a class="btn btn-primary" href="${pageContext.request.contextPath}/AccionCajero?action=1">Regresar a Transaccion Bancaria</a>
                        </div>
                    </div>
                </div>
            </c:if>
            <c:if test="${success==2}">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a class="btn btn-primary" href="${pageContext.request.contextPath}/AccionCajero?action=1">Realizar Otra Transaccion</a>
                        </div>
                    </div>
                </div>
            </c:if>
