<%-- 
    Document   : ReporteGerente2
    Created on : 15/11/2020, 19:13:44
    Author     : carlo
--%>
...
<html>
    <head>
        ...
        <title>Transaccione monetarias sumadas mayores a un limite</title>
        ...
        <div class="main">
            ...
            <c:if test="${success == 0}">
                <div class="container">
                    ...
                    <form action="ControladorReporteGerente2" onsubmit="return validarConsulta1()" method="POST">
            ...
            <c:if test="${success == 1}">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a class="btn btn-warning" value="1" name="generar" id="generar" href="${pageContext.request.contextPath}/ControladorReporteGerente2?limiteMonetario=${limiteMonetario}">Exportar Reporte PDF</a>
                        </div>
                        <div class="col-md-3">
                            <a class="btn btn-info" value="1" name="generar" id="generar" href="${pageContext.request.contextPath}/ControladorSolicitudGerente?reporte=2">Regresar a la ventana anterior</a>
                        </div>
                    </div>
                    <br/>
            ...
            <c:if test="${success == 3}">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a class="btn btn-primary" href="${pageContext.request.contextPath}/ControladorSolicitudGerente?reporte=2">Volver al formulario</a>
                        </div>
                    </div>
                </div>
            </c:if>
