<%-- 
    Document   : ReporteCliente4
    Created on : 13/11/2020, 17:35:00
    Author     : carlo
--%>
...
<html>
    <head>
        ...
        <title>Historial de solicitudes recibidas</title>
        ...
        <div class="main">
            ...
            <c:if test="${success == 0}">
                <div class="container">
                    <div>
                        <br>
                        <h5>Historial de Solicitudes de Asociacion Recibidas</h5>
                        <br>
                    </div>
                    <div class="container">
                        <form action="ControladorReporte4" method="POST">
