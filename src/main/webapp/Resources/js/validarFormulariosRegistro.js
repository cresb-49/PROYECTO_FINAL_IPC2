...
function validarCliente(){
    ...
    var pass1 = document.getElementById("passInicial").value;
    var pass2 = document.getElementById("passwordComparacion").value;

    var errores="";

    if(nombre ===""||sexo ===""||direccion === ""||dpi === ""||fechaNacimiento === ""||pass1 ===""||pass2 === ""){
...
function validarTabajador(){
    ...
    if(nombre === "" ||sexo===""||direccion===""||dpi===""||tipoTurno===""||pass1===""||pass2===""){
        alert("Todos los campos son obligaro");
        return false;
    }else{
        if(nombre.length>100){
            errores = errores + "\n- El nombre debe contener como maximo 100 caracteres";
