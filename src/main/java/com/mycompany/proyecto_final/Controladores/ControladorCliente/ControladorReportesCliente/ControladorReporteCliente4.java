...
@WebServlet("/ControladorReporte4")
public class ControladorReporteCliente4 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        if (req.getSession().getAttribute("USER") == null) {
            ...
            try {
                ...
                List<SolicitudAsociasion> solicitudes = modelSolicitud.BuscarSolicitudPropietarioTodas(uSistema.getCodigo().toString());
    
                if (solicitudes.isEmpty()) {
                    req.setAttribute("success", 5);
                    req.setAttribute("info", "No tiene ninguna solicitud de asociacion");
                    req.getRequestDispatcher("/Reportes/ReportesCliente/ReporteCliente4.jsp").forward(req, resp);
                } else {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        if (req.getSession().getAttribute("USER") == null) {
            ...
            try {
                ...
                resp.setHeader(HttpHeaders.CONTENT_DISPOSITION,"attachment; filename=Hitorial_Solictudes_Recibidas_Cliente_" + uSistema.getCodigo().toString()+".pdf");
                ...
                InputStream input = new FileInputStream(
                        req.getServletContext().getRealPath("/Resources/jasperReports/Cliente/ReporteCliente4.jrxml"));
